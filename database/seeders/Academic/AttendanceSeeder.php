...
class AttendanceSeeder extends Seeder {
    ...
    /**
     * Cria os registros simulados de frequência dos alunos.
     *
     * @return void
     */
    ...
    /**
     * Retorna o perfil simulado de frequência do aluno.
     *
     * @param int $studentId
     *
     * @return string
    ...
    private function getStudentAttendanceProfile(int $studentId): string {
        ...
        /* Simular que cada aluno tem um perfil de frequência Baseado no ID, manter consistência. */
        $seed = $studentId % 100;
    ...
    /**
     * Determina o status de frequência conforme o perfil simulado do aluno.
     *
    ...
    /**
     * Retorna uma justificativa aleatória para a ausência.
     *
     * @return string|null
     */
    ...
    /**
     * Exibe as estatísticas de frequência geradas pelo seeder.
     *
     * @return void
     */
