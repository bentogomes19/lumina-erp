...
return new class () extends Migration {
    ...
    public function up(): void {
        Schema::table('students', function (Blueprint $t) {
            if (!Schema::hasColumn('students', 'address_district')) {
                $t->string('address_district')->nullable();
            }
            if (!Schema::hasColumn('students', 'birth_city')) {
                $t->string('birth_city')->nullable();
            }
            if (!Schema::hasColumn('students', 'birth_state')) {
                $t->string('birth_state', 2)->nullable();
            }
            ...
            if (!Schema::hasColumn('students', 'guardian_main')) {
                $t->string('guardian_main')->nullable();
            }
            ...
            if (!Schema::hasColumn('students', 'transport_mode')) {
                $t->enum('transport_mode', ['none','car','bus','van','walk','bike'])->default('none');
            }
            ...
            if (Schema::hasColumn('students', 'cpf')) {
                ...
                try {
                    $t->unique('cpf', 'students_cpf_unique');
                } catch (\Throwable $e) {
                }
            }
        });
    ...
    public function down(): void {
        Schema::table('students', function (Blueprint $t) {
            ...
            try {
                $t->dropUnique('students_cpf_unique');
            } catch (\Throwable $e) {
            }
        });
    }
