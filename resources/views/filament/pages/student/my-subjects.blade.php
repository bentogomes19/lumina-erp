<x-filament-panels::page>
    ...
    <div style="display:flex;flex-direction:column;gap:1.5rem">
        ...
        @if($currentClass)
            <div
                style="background:rgba(30,41,59,0.7);border:1px solid rgba(255,255,255,0.08);border-radius:0.75rem;padding:1.25rem 1.5rem">
        ...
        @if($currentClass && $subjects->isNotEmpty())
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem">
                ...
                @foreach($statCards as $card)
                    <div
                        style="background:rgba(30,41,59,0.7);border:1px solid rgba(255,255,255,0.08);border-radius:0.75rem;padding:1rem">
                                ...
                                <div style="padding:1.25rem;display:flex;flex-direction:column;gap:0.875rem">
                                    ...
                                    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:0.75rem">
                                        <div style="display:flex;align-items:center;gap:0.75rem;min-width:0">
                                            ...
                                            <div style="min-width:0">
                                                <h4
                                                    style="font-size:0.9375rem;font-weight:600;color:#f1f5f9;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">
                                                    {{ $subject->name }}
                                                </h4>
                                                <div
                                                    style="display:flex;align-items:center;gap:0.375rem;font-size:0.6875rem;color:#94a3b8;margin-top:0.125rem">
                                                    @if($subject->code)
                                    ...
                                    @if(collect($subject->term_averages)->filter()->isNotEmpty())
                                        <div style="display:flex;flex-direction:column;gap:0.375rem">
                                            <p
                                                style="font-size:0.6875rem;font-weight:500;color:#64748b;text-transform:uppercase;letter-spacing:0.05em;margin:0">
                                            ...
                                            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:0.375rem">
                                                @foreach(['b1' => '1º Bim', 'b2' => '2º Bim', 'b3' => '3º Bim', 'b4' => '4º Bim'] as $termKey => $termLabel)
                                                                    ...
                                                                    @endphp
                                                     <div
                                                                        style="border-radius:0.375rem;padding:0.375rem;text-align:center;background:rgba(255,255,255,0.03)">
                                                                        <p style="font-size:0.5625rem;color:#64748b;margin:0">{{ $termLabel }}</p>
                                                                        <p
                                                                            style="font-size:0.8125rem;font-weight:700;color:{{ $termColor }};margin:0.125rem 0 0 0">
                                        ...
                                        <div style="display:flex;flex-direction:column;gap:0.25rem">
                                            <div
                                                ...
                                                <div style="display:flex;align-items:center;gap:0.5rem">
                                                    <span style="color:#64748b">{{ $subject->presences }}P /
                                            ...
                                            <div
                                                style="width:100%;height:5px;border-radius:999px;background:rgba(255,255,255,0.06);overflow:hidden">
                                                <div
                                    ...
                                    @if($subject->description)
                                        <p
                                            style="font-size:0.6875rem;color:#64748b;margin:0;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical">
                                            {{ $subject->description }}
                                        </p>
                                    @endif
                                </div>
        ...
        @else
            {{-- Empty state --}}
            <div
                style="background:rgba(30,41,59,0.7);border:1px solid rgba(255,255,255,0.08);border-radius:0.75rem;padding:3rem;text-align:center">
                <div
