...
return [
    ...
    'attributes' => [
        ...
        'email' => 'e-mail',
        'password' => 'senha',
        'student_source' => 'tipo de cadastro',
        'student_id' => 'aluno',
        'student_name' => 'nome completo',
        'student_cpf' => 'CPF',
        'student_rg' => 'RG',
        'student_birth_date' => 'data de nascimento',
        'student_gender' => 'gênero',
        'student_email' => 'e-mail',
        'student_phone_number' => 'telefone / celular',
        'school_year_id' => 'ano letivo',
        'class_id' => 'turma',
        'enrollment_date' => 'data da matrícula',
        'roll_number' => 'número de chamada',
        'status' => 'status',
        'student_postal_code' => 'CEP',
        'student_address' => 'endereço',
        'student_address_district' => 'bairro',
        'student_city' => 'cidade',
        'student_state' => 'UF',
        'student_mother_name' => 'nome da mãe',
        'student_father_name' => 'nome do pai',
        'student_guardian_main' => 'responsável legal',
        'student_guardian_phone' => 'telefone do responsável',
